  ...
  return (
    <div style={{ minHeight: "100vh", background: theme.bg, color: theme.text, fontFamily: "Arial", padding: "20px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
        ...
        <button onClick={() => setDark(!dark)} style={{ padding: "8px 12px", borderRadius: "6px", border: "none", cursor: "pointer" }}>
          {dark ? "☀ Light" : "🌙 Dark"}
        </button>
      </div>
      ...
      <div style={{ marginBottom: "20px" }}>
        {["nation", "technology", "business", "sports"].map((cat) => (
          <button key={cat} onClick={() => setCategory(cat)}
            style={{ marginRight: "10px", padding: "8px 12px", borderRadius: "6px", border: "none", cursor: "pointer", background: category === cat ? theme.accent : "#94a3b8", color: "white" }}>
            {cat}
          </button>
        ))}
      </div>
